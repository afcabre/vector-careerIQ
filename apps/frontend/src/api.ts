...
export type Opportunity = {
  ...
  vacancy_alignment_report_v2_artifact: Record<string, unknown>;
  vacancy_alignment_report_v2_status: "none" | "draft" | "approved" | "error";
  vacancy_alignment_report_v2_generated_at: string;
