    ...
    defaults: list[PromptConfigRecord] = [
        ...
        },
        {
            ...
            "template_text": (
                ...
                "about_the_company contiene solo descripcion de empresa, industria, mision, escala, contexto corporativo o senales reales del empleador. "
                "Si una frase empieza con el nombre de la empresa o con 'estamos buscando' pero describe el perfil buscado, capacidades, experiencia, liderazgo esperado o alcance del rol, no va en about_the_company; asignala a required_requirements o responsibilities segun su sentido principal. "
        ...
        },
        {
            ...
            "template_text": (
                ...
                "about_the_company debe conservar solo contexto corporativo real; si un bloque heredado desde vacancy_blocks empieza con la empresa o con una frase de apertura pero en realidad describe el perfil buscado, capacidades, experiencia o alcance del rol, reclasificalo como required_criteria o responsibilities segun el sentido principal. "
        ...
        },
        {
            ...
            "template_text": (
                ...
                "best_supporting_evidence_refs representa soporte minimo a nivel snippet. "
                ...
                "Opcionalmente puedes incluir support_note_short, pero solo si usa hechos visibles dentro de ese snippet. "
