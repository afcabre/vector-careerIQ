...
- endurecimiento semantico aplicado a `why_it_supports`: el prompt recomendado y el fallback backend de `S6.5` ahora exigen justificar relevancia con senales concretas del snippet, distinguiendo soporte directo/parcial/indirecto y evitando referencias vacias a `section unknown`
